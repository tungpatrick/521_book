...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{include_graphics}\NormalTok{(}\KeywordTok{rep}\NormalTok{(}\StringTok{"images/thanks.png"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\chapter{Thank you very much}\label{thank-you-very-much}
